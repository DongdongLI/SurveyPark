...
<html>
	<head>
		<title>Matrix Style Question Design</title>
	...
	<body>
		...
		<table>
			<tr>
				<td colspan="2" class="tdQHeaderL">Matrix Style Question Design:</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: right;vertical-align: top;">Row Title List:</td>
				<td width="*" style="text-align: left;"><s:textarea cols="41" rows="8" name="matrixRowTitle" /></td>
			</tr>
			<tr>
				<td style="text-align: right;vertical-align: top;">Column Title List:</td>
				<td width="*" style="text-align: left;"><s:textarea cols="41" rows="8" name="matrixColTitle" /></td>
			</tr>
			<tr>
				<td style="text-align: right;vertical-align: top;">Drop List:</td>
